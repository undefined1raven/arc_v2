...
export default function HomeScreen() {
  ...
  useEffect(() => {
    console.log(globalStyle.color, 'ax')
  }, [globalStyle.color])
  ...
  return (
    <View style={{ ...styles.container }}>
      ...
      <RLabel text='yeeey ediiii' backgroundColor={globalStyle.color + '20'} figmaImport={{ mobile: { top: 450, left: '50%', width: 320, height: 40 } }} horizontalCenter={true}></RLabel>
      <RButton onClick={() => {
