    ...
    tasks: [
        {
            ...
            routineConfig: { enabledDays: [0, 1, 2, 3, 4, 5, 6], isActive: false, timeConfig: [{ start: '22:00', end: '05:00' }] },
        ...
        },
        {
            ...
            routineConfig: { enabledDays: [0, 1, 2, 3, 4, 5, 6], isActive: false, timeConfig: null },
            isSpecialStatus: false
        },
        {
