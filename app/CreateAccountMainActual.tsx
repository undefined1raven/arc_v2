        ...
        >
          ...
          >
            <RLabel
              ...
              figmaImport={{
                mobile: { top: 10, left: 39, width: 65, height: 21 },
              }}
              fontSize={8}
              backgroundColor={globalStyle.color + "20"}
              text="Recommended"
            ...
            <RLabel
              figmaImportConfig={buttonContainerSize}
              figmaImport={{
                mobile: { top: 64, left: 17, width: "80%", height: 150 },
              }}
              fontSize={12}
              align="left"
              verticalCenter={true}
              text="This mode gives you seamless remote encrypted backups and the ability to log in from multiple devices into your account"
            ></RLabel>
            <RBox
              figmaImportConfig={buttonContainerSize}
              figmaImport={{
          ...
          >
            ...
            <RLabel
              ...
              align="left"
              verticalCenter={true}
              text="This mode lets you store all your data on your current device requiring a back-up file to log into any other devices"
            ></RLabel>
            <RBox
              figmaImportConfig={buttonContainerSize}
              figmaImport={{
          ...
          <RLabel
            figmaImport={{
              mobile: { top: 508, left: 50, width: 260, height: 38 },
            }}
            text="You can switch between these modes at any time"
            verticalAlign="center"
