            ...
            />
            {
                hasMounted ?
                    <Animated.View
                        ...
                        <RButton onClick={(e) => { saveKey() }} figmaImport={{ mobile: { left: 50, width: 260, height: 135, top: 155 } }}>
                            <RLabel fontSize={18} top="15%" width="100%" text='Download Key'></RLabel>
                            <DownloadDeco top="45%" width="100%"></DownloadDeco>
                        </RButton>
                        <RLabel figmaImport={{ mobile: { top: 306, left: 50, width: 260, height: 49 } }} text='This file contains everything you need to log in, even when offline' align='center' alignPadding={'3%'} verticalAlign='center' fontSize={14} backgroundColor={globalStyle.color + '20'}></RLabel>
                        <RLabel figmaImport={{ mobile: { top: 366, left: 50, width: 260, height: 49 } }} color={globalStyle.errorTextColor} text='Never share this file with anyone' align='center' alignPadding={'3%'} verticalAlign='center' fontSize={14} backgroundColor={globalStyle.errorColor + '20'}></RLabel>
                        <RButton androidRippleEnabled={hasDownloadKey} onClick={() => {
                            if (hasDownloadKey === true) {
                                navigation.navigate('OTSOne', { name: 'OTSOne' });
                            }
                        }} isEnabled={hasDownloadKey} figmaImport={{ mobile: { top: 430, left: 50, width: 260, height: 38 } }} label='Create Account' align='left' alignPadding={'3%'} verticalAlign='center' fontSize={14}></RButton>
                    </Animated.View>
                    : <RBox></RBox>}
        </View>)
}
