      ...
      {hasMounted ? (
        ...
        >
          ...
          <RButton
            ...
            androidRippleColor={globalStyle.colorInactive + "00"}
            figmaImport={{
              mobile: { top: 153, left: 50, width: 260, height: 44 },
            }}
          ...
          <RButton
            ...
            androidRippleColor={globalStyle.colorInactive + "00"}
            figmaImport={{
              mobile: { top: 217, left: 50, width: 260, height: 44 },
            }}
          ...
          <RButton
            onClick={() => {
              navigation.navigate("createAccountOnlineEmail");
            }}
            figmaImport={{
              mobile: { top: 281, left: 50, width: 260, height: 44 },
            }}
          ...
          <RLabel
            figmaImport={{
              mobile: { top: 347, left: 0, width: "100%", height: 15 },
            }}
            style
            text="or"
            fontSize={12}
          ...
          <RLabel
            figmaImport={{
              mobile: { top: 441, left: 50, width: 260, height: 100 },
            }}
            style={{ paddingLeft: "2%", paddingRight: "2%" }}
            text="The key file is a secure way of logging into your account without having to remember any credentials"
            verticalAlign="center"
            fontSize={12}
            backgroundColor={globalStyle.color + "20"}
          ></RLabel>
          <RButton
            onClick={(e) => {
              navigation.navigate("createAccountKeyFile");
            }}
            figmaImport={{
              mobile: { top: 385, left: 50, width: 260, height: 44 },
            }}
            label="Generate key file"
            align="left"
            mobileFontSize={15}
          ></RButton>
        </Animated.View>
