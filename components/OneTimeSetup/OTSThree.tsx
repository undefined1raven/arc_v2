            ...
            </RBox>
            {
                hasMounted ?
                    <Animated.View
                        ...
                        style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}>
                        <BackgroundTaskRunner messageHandler={e => { handleWrappedKeys(e) }} tx={codeTrigger} triggeredCode={wrapKeysWithPasswordCode(pin, SecureStore.getItem('temp-pk'), SecureStore.getItem('temp-symsk'))}></BackgroundTaskRunner>
                        ...
                        <RBox figmaImport={{ mobile: { top: 36, left: 18, width: 325, height: 36 } }} backgroundColor={globalStyle.color + '20'}>
                            ...
                            <RLabel figmaImportConfig={titleHeaderContainer} figmaImport={{ mobile: { left: 293, top: 0, width: '50%', height: '100%' } }} alignPadding="0%" verticalAlign='center' fontSize={15} align='left' text='3/3'></RLabel>
                        </RBox>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 86, width: '90%', height: 95 } }} alignPadding="0%" verticalAlign='top' fontSize={28} align='left' text='Set a PIN'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 127, width: '90%', height: 120 } }} alignPadding="0%" verticalAlign='top' fontSize={18} align='left' text='You can use this pin to better protect your data as well as a recovery method'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 210, width: '90%', height: 120 } }} alignPadding="0%" verticalAlign='top' fontSize={14} align='left' text='Set a new PIN [between 4 and 6 digits]'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 296, width: '90%', height: 120 } }} alignPadding="0%" verticalAlign='top' fontSize={14} align='left' text='Confirm PIN'></RLabel>
                        <RTextInput keyboardType='number-pad' returnKeyType='next' backgroundColor={pin.length > 0 ? isPinValid ? globalStyle.successColor : globalStyle.errorColor : globalStyle.color} borderColor={pin.length > 0 ? isPinValid ? globalStyle.successColor : globalStyle.errorColor : globalStyle.color} textContentType='password' secureTextEntry={true} textAlignVertical='center' align='left' alignPadding="2%" onInput={(e) => { setPINInput(e) }} figmaImport={{ mobile: { top: 232, left: 18, width: 321, height: 42 } }} fontSize={20}></RTextInput>
                        <RTextInput keyboardType='number-pad' returnKeyType='next' backgroundColor={pinConfirmation.length > 0 ? pin === pinConfirmation ? globalStyle.successColor : globalStyle.errorColor : globalStyle.color} borderColor={pinConfirmation.length > 0 ? pin === pinConfirmation ? globalStyle.successColor : globalStyle.errorColor : globalStyle.color} textContentType='password' secureTextEntry={true} textAlignVertical='center' align='left' alignPadding="2%" onInput={(e) => { setPinConfirmation(e) }} figmaImport={{ mobile: { top: 318, left: 18, width: 321, height: 42 } }} fontSize={20}></RTextInput>
                        <RButton onClick={() => { getWrappedKeysSaved() }} figmaImport={{ mobile: { top: 388, left: 18, width: 324, height: 53 } }} alignPadding={'3%'} verticalAlign='center' fontSize={14}>
                            <ArrowDeco width="15%" style={{ transform: [{ rotateZ: '0deg' }], left: '82%' }}></ArrowDeco>
                            <RLabel text='Continue' align='left' fontSize={18} left="3%" top="33%"></RLabel>
                        </RButton>
                        <RButton onClick={onSkipPin} label={!showSkipLoadingSpinner ? 'Skip' : ''} isEnabled={isSkipBoxChecked} androidRippleColor={isSkipBoxChecked ? globalStyle.errorColor + '30' : undefined} backgroundColor={isSkipBoxChecked ? globalStyle.errorColor : undefined} borderColor={isSkipBoxChecked ? globalStyle.errorColor : undefined} color={isSkipBoxChecked ? globalStyle.errorTextColor : undefined} figmaImport={{ mobile: { top: 537, left: 18, width: 324, height: 41 } }} verticalAlign='center' fontSize={14}><RBox left="45%" width="10%" height="100%"><ActivityIndicator animating={showSkipLoadingSpinner} color={globalStyle.errorColor} size={'large'}></ActivityIndicator></RBox></RButton>
                        <RBox figmaImport={{ mobile: { top: 592, height: 30, width: 324, left: 18 } }}>
                            <RButton onClick={() => { setIsSkipBoxChecked(prev => !prev); }} hoverOpacityMax={isSkipBoxChecked ? 'AA' : '20'} hoverOpacityMin={isSkipBoxChecked ? 'AA' : '00'} left="0%" width="9%" height="80%"></RButton>
                            <RLabel left="12%" width="86%" height="100%" alignPadding="0%" verticalAlign='center' fontSize={15} align='left' text='I understand that without the recovery codes I might lose access to my data'></RLabel>
