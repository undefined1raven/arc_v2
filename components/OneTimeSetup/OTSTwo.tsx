            ...
            </RBox>
            {
                hasMounted ?
                    <Animated.View
                        ...
                        <RLabel figmaImport={{ mobile: { left: 18, top: 86, width: '50%', height: 95 } }} alignPadding="0%" verticalAlign='top' fontSize={28} align='left' text='Recovery Codes'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 135, width: '90%', height: 120 } }} fontType='mono' alignPadding="0%" verticalAlign='top' fontSize={18} align='left' text='FIR02-D921X-MXIS9'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 150, width: '90%', height: 120 } }} fontType='mono' alignPadding="0%" verticalAlign='top' fontSize={18} align='left' text='FIR02-D921X-MXIS9'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 165, width: '90%', height: 120 } }} fontType='mono' alignPadding="0%" verticalAlign='top' fontSize={18} align='left' text='FIR02-D921X-MXIS9'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 180, width: '90%', height: 120 } }} fontType='mono' alignPadding="0%" verticalAlign='top' fontSize={18} align='left' text='FIR02-D921X-MXIS9'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 195, width: '90%', height: 120 } }} fontType='mono' alignPadding="0%" verticalAlign='top' fontSize={18} align='left' text='FIR02-D921X-MXIS9'></RLabel>
                        <RLabel figmaImport={{ mobile: { left: 18, top: 210, width: '90%', height: 120 } }} fontType='mono' alignPadding="0%" verticalAlign='top' fontSize={18} align='left' text='FIR02-D921X-MXIS9'></RLabel>
                        <RButton onClick={() => { navigation.navigate('OTSTwo', { name: 'OTSTwo' }) }} figmaImport={{ mobile: { top: 567, left: 18, width: 324, height: 53 } }} alignPadding={'3%'} verticalAlign='center' fontSize={14}>
